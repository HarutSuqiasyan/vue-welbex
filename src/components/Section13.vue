<template>
<div class="pl-50 pt-25 pb-12 max-[1300px]:pl-15 max-[1024px]:pl-10 max-[768px]:pl-6 max-[480px]:pl-4 flex flex-col flex-wrap relative">
    ...
    <div class="py-12">
        <h3 class="text-5xl text-light-text max-md:text-3xl max-sm:text-2xl">Бесплатная демонстрация</h3>
    </div>
    <div class="flex gap-45 pt-18 max-[1024px]:gap-20 max-[790px]:pt-12 max-[480px]:pt-6 max-[640px]:gap-8 flex-wrap">
        <div class="flex gap-5 flex-col">
            <p class="text-light-text text-2xl max-[640px]:text-xl max-[480px]:text-lg">Запишитесь на <span class="text-2xl bg-gradient-to-r from-orange-color via-[24%] to-red-color bg-clip-text text-transparent">бесплатную<br/> демонстрацию AmoCRM</span></p>
            <p class="text-light-text text-[18px] font-light">Мы быстро внедрим<br/> и настроим amoCRM в вашей<br/> компании!</p>
        </div>
